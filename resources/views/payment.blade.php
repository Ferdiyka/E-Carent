        ...
        <section class="bg-darkGrey relative py-[70px]">
            <div class="container">
                ...
                <div class="flex items-center gap-5 lg:justify-between">
                    <!-- Form Card -->
                    <form action="{{route('front.payment.update', $booking->id)}}"
                        method="POST"
                        ...
                        <div class="flex flex-col gap-[30px]">
                            <div class="flex flex-col gap-4">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <p class="text-base font-semibold">
                                        Rp {{number_format($booking->item->price)}}/day
                                    </p>
                                </div>
                                <!-- Items -->
                                <div class="flex items-center justify-between">
                                    ...
                                    <p class="text-base font-semibold">
                                        Rp {{number_format($booking->item->price * $booking->start_date->diffInDays($booking->end_date) * 0.1)}}
                                    </p>
                                </div>
                                <!-- Items -->
                                <div class="flex items-center justify-between">
                            ...
                            <div class="flex flex-col gap-4">
                                ...
                                <div class="grid md:grid-cols-2 gap-4 md:gap-[30px] items-center">
                                    <div class="relative boxPayment opacity-30">
                                        <input type="" value="" ="payment_method" id="coming soon"
                                            class="absolute inset-0 z-50 opacity-0 cursor-default">
                                        <label for="coming soon"
                                            class="flex items-center justify-center gap-4 border border-grey rounded-[20px] p-5 min-h-[80px]">
                                            {{-- <img src="/svgs/logo-wa.png" alt=""> --}}
                                            <p class="text-base font-semibold">
                                                &nbsp &nbsp &nbsp Coming Soon  &nbsp &nbsp &nbsp
                                            </p>
                                        </label>
                                    </div>
                                    <div class="relative boxPayment">
                                        ...
                                        <label for="midtrans"
                                            class="cursor-pointer flex items-center justify-center gap-4 border border-grey rounded-[20px] p-5 min-h-[80px]">
                    ...
                    <img src="/images/payment-img.png" class="max-w-[50%] hidden lg:block -mr-[100px]"
                        alt="">
                </div>
            </div>
        </section>
