<x-app-layout>
  ...
  <x-slot name="header">
    <h2 class="text-xl font-semibold leading-tight text-gray-800">
      ...
      Booking &raquo; Edit &raquo; #{{$booking->id}}
    </h2>
  </x-slot>
        ...
        <form class="w-full" action="{{ route('admin.bookings.update', $booking->id) }}" method="post" enctype="multipart/form-data">
          ...
          <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
            <div class="w-full">
              ...
              <div class="mt-2 text-sm text-gray-500">
                Contoh: Jl. Puri Beta, Kec. Larangan
              </div>
            </div>
          </div>
          ...
          <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
            <div class="w-full">
              ...
              <select name="status" class="cursor-pointer block w-full px-4 py-3 leading-tight text-gray-700 border border-gray-200 rounded appearance-none bg-white-200 focus:outline-none focus:bg-white focus:border-gray-500">
          ...
          <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
            <div class="w-full">
              ...
              <select name="payment_status" class="cursor-pointer block w-full px-4 py-3 leading-tight text-gray-700 border border-gray-200 rounded appearance-none bg-white-200 focus:outline-none focus:bg-white focus:border-gray-500">
