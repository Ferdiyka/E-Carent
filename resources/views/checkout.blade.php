        ...
        <section class="bg-darkGrey relative py-[70px]">
            <div class="container">
                ...
                <div class="flex items-center gap-5 lg:justify-between">
                        ...
                        <div class="grid grid-cols-2 items-center gap-y-6 gap-x-4 lg:gap-x-[30px]">
                            ...
                            <div class="flex flex-col col-span-2 gap-3">
                                ...
                                <input type="text" name="name" id="name"
                                    ...
                                    placeholder="Insert Full Name" value="">
                            </div>
                            ...
                            <div class="col-span-2 grid grid-cols-2 gap-y-6 gap-x-4 lg:gap-x-[30px] relative"
                                ...
                                <div class="flex flex-col col-span-1 gap-3">
                                    ...
                                    <input readonly type="text"
                                        class="cursor-pointer text-base font-medium focus:border-primary focus:outline-none placeholder:text-secondary placeholder:font-normal px-[26px] py-4 border border-grey rounded-[50px] focus:before:appearance-none focus:before:!content-none"
                    ...
                    <img src="{{ $gambar_url }}" class="max-w-[50%] hidden lg:block -mr-[100px]" alt="">
                </div>
            </div>
        </section>
